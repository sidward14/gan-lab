...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser( prog = 'GAN Zoo', description = 'StyleGAN, ProGAN, and ResNet GANs (model configuration)' )
  ...
  if sys.argv[1].casefold() in ( 'resnet', 'res-net', 'res net', 'resnet gan',
    ...
    raise ValueError( 'Invalid model input. This GAN Zoo currently only' + \
